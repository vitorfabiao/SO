/*Trabalho realizado por: Pedro Rodrigues 21280225
						  Vitor Fabião 21271030
						  
Sistema MSGDIST, Sistemas operativos, trabalho prático 2019/2020*/
#include "gestor.h"
...
___________________________________________________________________*/
	...
	if(value_wordsnot == NULL){//Vai à procura da variável de ambiente com o nome WORDSNOT, verifica se tem alguma string com o nome do ficheiro texto e se tiver guarda para dentro do array
...
___________________________________________________________________*/
    ...
    while(1){
    	...
    	while ( (token[++arguments] = strtok(NULL," ")) != NULL);
	      	...
	      	if(strcmp("filter",token[0])==0){ //compara o comando com a palavra que o utilizador colocou
	      		if(strcmp("on\n",token[1])==0)
	      			printf("Filter is on\n");
	      		else if(strcmp("off\n",token[1])==0)
